...
function OverviewBar({  chartItem }: OverviewBarProps) {
  ...
  const overviewData = {
    ...
    interest: new Intl.NumberFormat("currency",{maximumFractionDigits: 0}).format(totalInterest),
